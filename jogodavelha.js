/* 
  ...
  até 4 jogadas ganha-se 2 pontos
  jogo reinicia após 5 segundos se tiver vitória ou "dar velha"
  meu jogo está no github! https://github.com/Guipegoraro/TicTacToe
...
let jogadasX = 0;
const jogadorXplacar = document.getElementById("jogadorX");
let jogadorOpontos = 0;
let jogadasO = 0;
const jogadorOplacar = document.getElementById("jogadorO");
let casa1 = null;
let casa2 = null;
let casa3 = null;
let casa4 = null;
...
let tile8 = 0;
let tile9 = 0;
const vitoriaUsuario = document.getElementById("vitoriaUsuario");
let podeJogar = 1;
let acabouJogo = 0;
...
function verificarVelha() {
  if (
    ...
    vitoriaUsuario.innerText = "Deu velha! reiniciando em 5 segundos...";
